    ...
    <>
      <section className="hero">
        <div className="container hero-grid">
          <div>
            ...
            <h1>Build the future with practical AI skills.</h1>
            <p>Centram AI equips learners and organisations with industry-relevant artificial intelligence, machine learning and data skills.</p>
      ...
      <section className="section">
        <div className="container">
          <div className="section-heading">
            <div><span className="eyebrow">FEATURED PROGRAMMES</span><h2>Learn skills that solve real problems.</h2></div>
      ...
      <section className="section soft-section">
        <div className="container feature-grid">
          ...
          <div><span className="icon-box">03</span><h3>Career Support</h3><p>Receive guidance on portfolios, interviews, internships and career pathways.</p></div>
        </div>
      </section>
